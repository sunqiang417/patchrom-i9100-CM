...
.method static synthetic access$800(Lcom/android/OriginalSettings/bluetooth/DockService;)Landroid/widget/CheckBox;
    .locals 1
    .parameter "x0"

    .prologue
    .line 51
    iget-object v0, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mAudioMediaCheckbox:Landroid/widget/CheckBox;
...
.method private createDialog(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    .prologue
    .line 482
    iget-object v4, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mDialog:Landroid/app/AlertDialog;
    ...
    iput-object v4, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mDialog:Landroid/app/AlertDialog;
    ...
    invoke-virtual {p0, v4, v6}, Lcom/android/OriginalSettings/bluetooth/DockService;->startForeground(ILandroid/app/Notification;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/OriginalSettings/bluetooth/DockService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iput-object v4, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mAudioMediaCheckbox:Landroid/widget/CheckBox;
    ...
    invoke-static {p0, v4}, Lcom/android/OriginalSettings/bluetooth/LocalBluetoothPreferences;->hasDockAutoConnectSetting(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0, v8}, Lcom/android/OriginalSettings/bluetooth/DockService;->initBtSettings(Landroid/bluetooth/BluetoothDevice;IZ)[Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v4}, Lcom/android/OriginalSettings/bluetooth/DockService;->getString(I)Ljava/lang/String;
    ...
    .line 516
    iget-object v4, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mCheckedItems:[Z

    iget-object v6, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mMultiClickListener:Landroid/content/DialogInterface$OnMultiChoiceClickListener;
    ...
    invoke-static {p0, v4}, Lcom/android/OriginalSettings/bluetooth/LocalBluetoothPreferences;->getDockAutoConnectSetting(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 526
    iget-object v4, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mCheckedChangeListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    iget-object v6, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mClickListener:Landroid/content/DialogInterface$OnClickListener;
    ...
    iput v0, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mStartIdAssociatedWithDialog:I
    ...
    iget-object v6, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mDismissListener:Landroid/content/DialogInterface$OnDismissListener;
    ...
    .line 538
    invoke-virtual {p0}, Lcom/android/OriginalSettings/bluetooth/DockService;->getContentResolver()Landroid/content/ContentResolver;
    ...
    :goto_4
    iget-object v4, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mAudioMediaCheckbox:Landroid/widget/CheckBox;
    ...
    iget-object v6, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mCheckedChangeListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;
...
.method private msgTypeDocked(Landroid/bluetooth/BluetoothDevice;II)Z
    ...
    invoke-virtual {v3, v4}, Lcom/android/OriginalSettings/bluetooth/DockService$ServiceHandler;->removeMessages(I)V
    ...
    .line 378
    iget-object v3, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-direct {p0, v3}, Lcom/android/OriginalSettings/bluetooth/DockService;->handleUndocked(Landroid/bluetooth/BluetoothDevice;)V
    ...
    invoke-virtual {v3, p0}, Lcom/android/OriginalSettings/bluetooth/LocalBluetoothProfileManager;->addServiceListener(Lcom/android/OriginalSettings/bluetooth/LocalBluetoothProfileManager$ServiceListener;)V

    .line 390
    iget-object v3, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mProfileManager:Lcom/android/OriginalSettings/bluetooth/LocalBluetoothProfileManager;

    invoke-virtual {v3}, Lcom/android/OriginalSettings/bluetooth/LocalBluetoothProfileManager;->isManagerReady()Z
    ...
    invoke-virtual {v2, p0}, Lcom/android/OriginalSettings/bluetooth/LocalBluetoothProfileManager;->removeServiceListener(Lcom/android/OriginalSettings/bluetooth/LocalBluetoothProfileManager$ServiceListener;)V
    ...
    new-instance v3, Lcom/android/OriginalSettings/bluetooth/DockService$1;

    invoke-direct {v3, p0, v0, p2, p3}, Lcom/android/OriginalSettings/bluetooth/DockService$1;-><init>(Lcom/android/OriginalSettings/bluetooth/DockService;Landroid/bluetooth/BluetoothDevice;II)V

    iput-object v3, p0, Lcom/android/OriginalSettings/bluetooth/DockService;->mRunnable:Ljava/lang/Runnable;
    ...
    invoke-direct {p0, v3, p2, p3}, Lcom/android/OriginalSettings/bluetooth/DockService;->handleDocked(Landroid/bluetooth/BluetoothDevice;II)V
