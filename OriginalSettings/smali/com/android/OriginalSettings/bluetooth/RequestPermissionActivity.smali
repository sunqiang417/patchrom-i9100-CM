...
.method private proceedAndFinish()V
    ...
    .prologue
    .line 223
    iget-boolean v3, p0, Lcom/android/OriginalSettings/bluetooth/RequestPermissionActivity;->mEnableOnly:Z
    ...
    :cond_0
    :goto_0
    iget-object v3, p0, Lcom/android/OriginalSettings/bluetooth/RequestPermissionActivity;->mDialog:Landroid/app/AlertDialog;
    ...
    .line 248
    :cond_1
    invoke-virtual {p0, v2}, Lcom/android/OriginalSettings/bluetooth/RequestPermissionActivity;->setResult(I)V
    ...
    :cond_2
    iget-object v3, p0, Lcom/android/OriginalSettings/bluetooth/RequestPermissionActivity;->mLocalAdapter:Lcom/android/OriginalSettings/bluetooth/LocalBluetoothAdapter;

    const/16 v4, 0x17

    iget v5, p0, Lcom/android/OriginalSettings/bluetooth/RequestPermissionActivity;->mTimeout:I

    invoke-virtual {v3, v4, v5}, Lcom/android/OriginalSettings/bluetooth/LocalBluetoothAdapter;->setScanMode(II)Z
    ...
    .line 230
    .local v0, endTime:J
    invoke-static {p0, v0, v1}, Lcom/android/OriginalSettings/bluetooth/LocalBluetoothPreferences;->persistDiscoverableEndTimestamp(Landroid/content/Context;J)V
    ...
    .line 233
    invoke-static {p0, v0, v1}, Lcom/android/OriginalSettings/bluetooth/BluetoothDiscoverableTimeoutReceiver;->setDiscoverableAlarm(Landroid/content/Context;J)V
